...
@ptbox.MODELS.register
def san(sa_type, layers, kernels, num_classes):
    model = SAN4(sa_type, Bottleneck, layers, kernels, num_classes)
    return model


if __name__ == '__main__':
    net = san(sa_type=0, layers=(3,3,3,3), kernels=[3,3,3,3], num_classes=10).cuda().eval()
    print(net)
